...
export class AgentComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private fb:FormBuilder ,private adminService: AdminServiceService) { }
  ...
  allAgent() {
    this.adminService.getAllAgent().subscribe((data: any) => {
      this.agentList = data.items;
      this.rows = data.items;
      this.tempData = this.rows;
      this.kitchenSinkRows = this.agentList;
      this.filteredData = this.agentList;
    });
  }
